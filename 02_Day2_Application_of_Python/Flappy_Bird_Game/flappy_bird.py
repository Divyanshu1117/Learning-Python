...
SPRITES_PATH = os.path.join(GALLERY_PATH, "sprites")
AUDIO_PATH = os.path.join(GALLERY_PATH, "audio")

# Sprite locations
PLAYER = os.path.join(SPRITES_PATH, "bird.png")
BACKGROUND = os.path.join(SPRITES_PATH, "background.png")
PIPE = os.path.join(SPRITES_PATH, "pipe.png")
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Flappy Bird by DV")
    ...
    GAME_SPRITES["message"] = pygame.image.load(
        os.path.join(SPRITES_PATH, "message.png")
    ).convert_alpha()
    GAME_SPRITES["base"] = pygame.image.load(
        os.path.join(SPRITES_PATH, "base.png")
    ).convert_alpha()
    GAME_SPRITES["pipe"] = (
